...
export const markCompleted = async (req, res) => {
    try {
        ...
        await conn.query("UPDATE meetings SET meeting_status = 'completed' WHERE id = ?", [meetingId]);
